...
class Reco2 extends StatelessWidget {
  const Reco2({Key? key, required selected, required id});
              ...
              onPressed: () async {
                ...
                setState(() {
                  ...
                  if(finalResponse.isNotEmpty) {
                    AssetImage assetImage = AssetImage('assets/$finalResponse.jpg');
