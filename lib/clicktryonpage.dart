...
class Clicktryonpage extends StatelessWidget {

  var selected;
  var id;
  Clicktryonpage({required this.selected,required this.id});
        ...
        children: [
          ...
          Center(
            child: OutlinedButton(
              ...
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Reco(selected: selected, id: id,)));
              },
            ),
          ),
        ],
