...
import 'package:firebaseauthentication/reco2.dart';
...
class Clicktryonpage2 extends StatelessWidget {

  var selected;
  var id;
  Clicktryonpage2({required this.selected,required this.id});
        ...
        children: [
          ...
          Center(
            child: OutlinedButton(
              ...
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Reco2(selected: selected, id: id,)));
              },
            ),
          ),
        ],
